...
-- luacheck: globals Base64

-- twisted for Murano's module system.

Base64 = {}

Base64.__author__ = 'Daniel Lindsley'
Base64.__version__ = 'scm-1'
Base64.__license__ = 'BSD'


--Base64.index_table = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'
-- Use URL safe characters
Base64.index_table = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_'
...
function Base64.to_base64(to_encode)
    ...
    for i = 1, string.len(bit_pattern), 6 do
        ...
        encoded = encoded .. string.sub(Base64.index_table, offset+1, offset+1)
    end
...
function Base64.from_base64(to_decode)
    ...
    for i = 1, string.len(unpadded) do
        ...
        local offset, _ = string.find(Base64.index_table, char)
        if offset == nil then
